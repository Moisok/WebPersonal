...
<body>
    ...
    <table border="1">
	    ...
	    <tr>
	        <td>Descripcion:</td>
	        <td>
	            <textarea name="nuevaDescripcion" id="nuevaDescripcion" maxlength="205">${proyecto.descripcion}</textarea>
	        </td>
	    ...
	    <tr>
	        <td>Descripcion:</td>
	        <td>
	             <textarea name="nuevaDescripcion" id="nuevaDescripcion" maxlength="205"></textarea>
    		</td>
